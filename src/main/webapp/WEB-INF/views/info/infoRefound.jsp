   ...
   <div class="container">
      ...
      <div class="content">
         ...
         <div class="slider">
            ...
            <p style="text-indent: 10px;"> 아래와 같이 운영하고 있으니 확인하시고 예약해 주시기 바랍니다. </p>
            <p>   - 보호자 동반 없는 미성년자 예약 발견시, 환불 없이 예약취소됩니다. </p>
            <p> - 예약일 변경시 발생하는 수수료는 취소 수수료와 동일하게 적용되오니 </p>
            <p style="text-indent: 10px;"> 예약시 신중히 생각하시고 결정해 주시기 바랍니다. </p>
            </div>
            <br>
            <table class="table table-strped table-hover">
            <thead>
               <tr style="word-spacing: 40px; text-align:center">
                  <th>이용 당일</th>
                  <th>이용 1일전</th>
                  <th>이용 2일전</th>
                  <th>이용 3일전</th>
