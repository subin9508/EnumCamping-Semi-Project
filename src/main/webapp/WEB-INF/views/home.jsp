...
<div class="wrapper">
	...
	<section class="content">
		<div
			...
			<div class="row">
				<div class="col-md-5">
					<img src="images/main/main-camp.jpg" class="img-fluid"
						alt="Main Camping Image">
				</div>
				<div class="col-md-7 rounded-content jua-regular with-background">
					<h2>자연 속에서의 휴식</h2>
					<p>Enum Camping은 자연 속에서 편안한 휴식을 제공합니다. 넓은 공간과 풍부한 자연 경관이 매력적인 이
						캠핑장에서는 언제든지 편안하게 쉴 수 있습니다.</p>
					...
					<p>Enum Camping은 환경 보호를 중요시하며, 지속 가능한 캠핑을 지향합니다. 방문객 여러분께서도 자연을
						존중하며 즐거운 캠핑을 즐길 수 있도록 협조 부탁드립니다.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="notice" class="section"
		...
		<div class="container jua-regular" style="color: white;">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="card border-3 border-light mt-5">
						<div class="card-body">
