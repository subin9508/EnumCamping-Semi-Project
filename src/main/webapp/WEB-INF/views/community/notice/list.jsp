...
main {
	...
	/* Ensures all children are stacked vertically */
						...
						<div class="card-header" style="background-color: white;">
							...
							<form action="${noticeSearchPage }">
								<div class="row">
									...
									<div class="col-2">
										<input type="submit"
											class="form-control btn btn-outline-primary" value="검색" />
									</div>
									<div class="col-2">
										<button type="button"
											class="form-control btn btn-outline-primary"
											onclick="location.href='/semiproject/community/notice/list'">전체
											목록</button>
									</div>
								</div>
							</form>
							...
							<table class="table table-hover">
								...
								<tbody>
									<c:forEach var="n" items="${notices}">
										<tr
											onclick="location.href='${pageContext.request.contextPath}/community/notice/details?id=${n.id}'"
											style="cursor: pointer; text-align: center;">
											<td class="col-2">${n.id}</td>
											<td class="col-7">${n.title}</td>
