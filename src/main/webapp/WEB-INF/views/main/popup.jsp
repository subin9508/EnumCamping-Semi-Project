...
.popup {
	...
	border-radius: 8px;
	width: 30%; // 폭 고정 min-width : 300px; // 최대 폭 제한 margin : 0 10px; //
	팝업 사이의 간격 조정 padding : 20px;
	position: relative;
	display: flex;
...
<body>
	...
	<div class="layerpopup" id="layer_popup">
		<div class="popup" id="popup1">
			<img src="./images/main/popup_open.png" alt="popup1"
			...
			<div class="pop_check_button" name="pop_check_button">
				...
				<a href="javascript:closePop1();" id="close1"
					style="margin-tight: 5px">닫기</a>
			</div>
		</div>


		<div class="popup" id="popup2">
			<img src="./images/main/popup_bbqset.png" alt="popup2"
				style="width: 100%; height: auto;">
			...
			<div class="pop_check_button" name="pop_check_button">
				...
				<a href="javascript:closePop2();" id="close2"
					style="margin-tight: 5px">닫기</a>
			</div>
		</div>
	</div>
	...
	<script>
		...
		function checkPopupsAndHideOverlay() {
			if (document.getElementById('popup1').classList.contains('hidden')
					&& document.getElementById('popup2').classList
							.contains('hidden')) {
				...
				.addEventListener(
						...
						function(event) {
							if (!event.target.closest('.popup')
								...
								if (document.getElementById('popup1').classList
										.contains('hidden')
										&& document.getElementById('popup2').classList
												.contains('hidden')) {
									document.getElementById('layer_popup').style.display = 'none';
