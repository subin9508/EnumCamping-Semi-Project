                    ...
                    <div class="slider">
                        ...
                        <div class="descriptions2">
                            ...
                            <div class="details2">
                                    <div class="item">
                                        <div class="div3">
                                        예약시 주차 등록한 차량만 주차 가능합니다.
                                        <br />
                                        <br />
                                        들어오는 입구가 좁아 조심히 들어오셔야 됩니다.                                      
                                        </div>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="horizontal-border">
                            <div class="descriptions3">
                                ...
                                <div class="details3">
                                    <div class="div6">
                                    홍천터미널 -> 수타사행 버스(30~35분 소요) -> 수타사 하차 -> 도보로 650m(약 11분 소요)
                                    <br />
                                    <br />
                                    홍천 터미널 -> 신봉행 버스(30~35분 소요) -> 구종점 하차 -> 도보로 1.4KM(약 23분 소요)
                                    </div>
                                </div>
                            </div>
                        </div>
