                ...
                <div class="responsive-image">
                    <a
                        ...
                        target="_blank"> <c:url
                            ...
                            var="intro2_valley" /> <img alt="valley"
                        src="${intro2_valley}" width="600" height="400" />
                    </a>
                </div>
                <div class="mt-2">
                    <h5><strong>수타사 계곡</strong></h5>
                </div>
                ...
                <div class="responsive-image">
                    <a
                        ...
                        target="_blank"> <c:url
                            ...
                            var="intro2_temple" /> <img alt="trail"
                        src="${intro2_temple}" width="600" height="400" />
                    </a>
                </div>
                <div class="mt-2">
                    <h5><strong>수타사</strong></h5>
                </div>
                <div style="display: flex; align-items: center;">
                    <a
                ...
                <div class="responsive-image">
                    <a
                        ...
                        target="_blank"> <c:url
                            ...
                            var="intro2_beef" /> <img alt="beef"
                        src="${intro2_beef}" width="600" height="400" />
                    </a>
                </div>
                <div class="mt-2">
                    <h5><strong>홍천한우수라</strong></h5>
                </div>
                <div style="display: flex; align-items: center;">
                    <a
                        href="https://map.naver.com/p/search/%ED%99%8D%EC%B2%9C%ED%95%9C%EC%9A%B0%EC%88%98%EB%9D%BC/place/1241815713?c=15.00,0,0,0,dh&isCorrectAnswer=true"
                ...
                <div class="responsive-image">
                    <a
                        ...
                        target="_blank"> <c:url
                            ...
                            var="intro2_noodle" /> <img alt="noodle"
                        src="${intro2_noodle}" width="600" height="400" />
                    </a>
                </div>
                <div class="mt-2">
                    <h5><strong>홍천강막국수</strong></h5>
                </div>
                <div style="display: flex; align-items: center;">
                    <a
                        href="https://map.naver.com/p/search/%ED%99%8D%EC%B2%9C%EA%B0%95%EB%A7%89%EA%B5%AD%EC%88%98?c=15.00,0,0,0,dh"
